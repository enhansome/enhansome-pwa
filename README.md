...
* [`PWA Asset Generator`](https://github.com/elegantapp/pwa-asset-generator) ⭐ 3,032 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-10: Automates PWA asset generation and image declaration. Automatically generates icon and splash screen images, favicons and mstile images.
...
* [`Workbox`](https://github.com/GoogleChrome/workbox) ⭐ 13,011 | 🐛 70 | 🌐 JavaScript | 📅 2026-09-02: Javascript Library for building progressive web apps
