...
* [Foldergram](https://github.com/foldergram/foldergram) ⭐ 566 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-03: Local-only photo and video gallery for folders, with an Instagram-inspired browsing pattern.
...
* [`PWA Asset Generator`](https://github.com/elegantapp/pwa-asset-generator) ⭐ 3,036 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-24: Automates PWA asset generation and image declaration. Automatically generates icon and splash screen images, favicons and mstile images.
...
* [`Workbox`](https://github.com/GoogleChrome/workbox) ⭐ 13,022 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-02: Javascript Library for building progressive web apps
